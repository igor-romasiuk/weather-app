...
describe('CityCard Component', () => {
  ...
  test('renders basic city information', () => {
    renderWithRedux(<CityCard city={mockCity} />);
  ...
  test('renders weather data when fetch succeeds', () => {
    ...
    expect(screen.getByAltText('scattered clouds')).toHaveAttribute(
      'src',
  ...
  test('calls onClick prop when card is clicked', () => {
    ...
    renderWithRedux(<CityCard city={mockCity} onClick={handleClick} />);
